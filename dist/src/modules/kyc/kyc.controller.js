...
let KycController = (() => {
    let _classDecorators = [(0, common_1.Controller)('kyc')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _handleWebhook_decorators;
    var KycController = _classThis = class {
    ...
    (() => {
        ...
        _handleWebhook_decorators = [(0, common_1.Post)('webhook'), (0, common_1.UseGuards)(webhook_signature_guard_1.WebhookSignatureGuard), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
